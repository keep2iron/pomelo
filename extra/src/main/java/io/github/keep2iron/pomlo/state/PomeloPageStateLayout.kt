...
class PomeloPageStateLayout : FrameLayout {
  ...
  fun displayNetworkError() {
    if (pageState != PageState.NETWORK_ERROR) {
      ...
      val view =
        views[pageState] ?: throw IllegalArgumentException("you should add network error layout")
  ...
  fun displayEmptyData() {
    if (pageState != PageState.EMPTY_DATA) {
      ...
      val view =
        views[pageState] ?: throw IllegalArgumentException("you should add empty data layout")
      animStateView(preState, view)
    }
  }
  ...
  fun displayLoadError() {
    if (pageState != PageState.LOAD_ERROR) {
      ...
      val view =
        views[pageState] ?: throw IllegalArgumentException("you should add load error layout")
      animStateView(preState, view)
    }
  }
  ...
  fun setPageStateReloadListener(
    pageState: PageState,
